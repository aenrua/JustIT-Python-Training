...
# invoke the input function and assign to name variable to dynamically ask for user input instead of hardcoded values
...
"To DO: Exercise: Provide screenshot to the answers to the questions below in the chat"
