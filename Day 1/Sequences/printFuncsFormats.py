"Read through the print statement formatting examples and reference or use it as a guide during lesson"
...
print("All the power\n is within you")
num1,num2=10,5
print(num1,num2) # without separator
""" Use of separator function """
print(num1,num2, sep=',') # the separator separates the data printed using the separator character used
...
"""Use of curly braces place holders and string format function to format print statement"""
